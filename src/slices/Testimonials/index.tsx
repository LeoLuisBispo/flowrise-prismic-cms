...
const components: JSXMapSerializer = {
  ...
  paragraph: ({ children }) => (
    <p className="text-xl md:text-2xl font-normal font-body text-slate-600 mb-8 sm:text-left text-center">
      {children}
    </p>
  ),
};
...
const Testimonials = async ({
  ...
  return (
    ...
    >
      <PrismicRichText components={components} field={slice.primary.headin} />
